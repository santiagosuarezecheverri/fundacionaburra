...
class WDWT_front
{
  ...
  public function head_advertisment()
  {
    ...
    switch ($integration_head_adsense_type) {
      case 'adsens':
        ?>
        <div class="advertismnet" id="top-advertismnet">
        <?php
        $integration_head_adsense = html_entity_decode(stripcslashes($this->get_param('integration_head_adsense')));
        echo $integration_head_adsense;
        ?>
        </div><?php
        break;
      case 'advertisment':
