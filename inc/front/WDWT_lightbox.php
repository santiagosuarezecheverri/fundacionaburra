...
class WDWT_Lightbox
{
  ...
  public function __construct()
  {
    ...
    $this->wdwt_front = new news_magazine_front($wdwt_options);
  ...
  public function view()
  {
    ...
    <style>
      ...
      <?php echo $theme_row['lightbox_ctrl_cont_bg_color']; ?>  ;*/
      <?php
      ...
      <?php echo number_format($theme_row['lightbox_ctrl_cont_transparent'] / 100, 2, ".", ""); ?>  ;
        filter: Alpha(opacity=

      <?php echo $theme_row['lightbox_ctrl_cont_transparent']; ?>  );*/
        position: absolute;
      ...
      <?php echo ( $theme_row['lightbox_ctrl_btn_pos'] == 'bottom' && $theme_row['lightbox_info_pos'] == 'bottom') ? 'bottom: ' . ($theme_row['lightbox_ctrl_btn_height'] + 2 * $theme_row['lightbox_ctrl_btn_margin_top']) . 'px;' : '' ?><?php if($popup_info_full_width) { ?> width: 100%;
      <?php } else { ?> margin: <?php echo $theme_row['lightbox_info_margin']; ?>;
      <?php } ?> padding: <?php echo $theme_row['lightbox_info_padding']; ?>;
    ...
    <?php
    if (!$image_id_exist) {
      echo '<div style="width:99%"><div class="error"><p><strong>' . __('The image has been deleted.', "news-magazine") . '</strong></p></div></div>';
      die();
    }
    ?>
    ...
    <div class="wdwt_image_wrap">
        ...
        <div class="wdwt_btn_container">
          <div class="wdwt_ctrl_btn_container">
            ...
            if ($enable_image_ctrl_btn) {
              ?>
              <i title="<?php esc_attr_e('Play', "news-magazine"); ?>" class="wdwt_ctrl_btn wdwt_play_pause fa fa-play"></i>
              <?php
            }
            ...
            if ($popup_enable_info) { ?>
              <i title="<?php echo esc_attr_e('Show info', "news-magazine"); ?>"
                 class="wdwt_ctrl_btn wdwt_info fa fa-info"></i>
              <?php
            }
            if ($popup_enable_fullsize_image) {
              ?>
              <a id="wdwt_fullsize_image" href="<?php echo $current_image_url; ?>" target="_blank">
                <i title="<?php echo esc_attr_e('Open image in original size.', "news-magazine"); ?>"
                   class="wdwt_ctrl_btn fa fa-external-link"></i>
              </a>
              <?php
            }
            ?>
          ...
          <div class="wdwt_toggle_container">
            <i
              class="wdwt_toggle_btn fa <?php echo(($theme_row['lightbox_ctrl_btn_pos'] == 'top') ? 'fa-angle-up' : 'fa-angle-down'); ?>"></i>
          </div>
        </div>
        <?php
      }
      ...
      <div id="wdwt_image_container" class="wdwt_image_container">
        <div class="wdwt_image_info_container1">
          <div class="wdwt_image_info_container2">
            <span class="wdwt_image_info_spun">
              <div
                class="wdwt_image_info" <?php if (trim($current_image_alt) == '' && trim($current_image_description) == '') {
            ...
            <div class="wdwt_slider">
              ...
              foreach ($image_rows as $key => $image_row) {
                ...
                <span class="wdwt_popup_image_spun1" style="display: table; width: inherit; height: inherit;">
                  <span class="wdwt_popup_image_spun2"
        ...
        <a id="wdwt_spider_popup_left"><span id="wdwt_spider_popup_left-ico"><span><i
                class="wdwt_prev_btn fa fa-chevron-left"></i></span></span></a>
        <a id="wdwt_spider_popup_right"><span id="wdwt_spider_popup_right-ico"><span><i
                class="wdwt_next_btn fa fa-chevron-right"></i></span></span></a>
      </div>
    </div>
    <a class="wdwt_spider_popup_close" onclick="wdwt_lbox.destroypopup(1000); return false;"
       ontouchend="wdwt_lbox.destroypopup(1000); return false;"><span><i class="wdwt_close_btn fa fa-times"></i></span></a>
    ...
    <script>
      ...
      function wdwt_popup_resize()
      {
        ...
        if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen) && !jQuery.fullscreen.isFullScreen()) {
          ...
          jQuery(".wdwt_resize-full").attr("title", "<?php esc_attr_e('Maximize', "news-magazine"); ?>");
          jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen");
          jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Fullscreen', "news-magazine"); ?>");
        }
        ...
        if (jQuery(window).width() >= <?php echo $image_width; ?> && <?php echo $open_with_fullscreen ? 1 : 0; ?> != 1) {
          ...
          jQuery(".wdwt_ctrl_btn.wdwt_fullscreen.fa.fa-fullscreen").remove();
          jQuery(".wdwt_popup_image").css({
      ...
      jQuery(document).ready(function ()
      {
        ...
        jQuery(".wdwt_info").on(wdwt_click, function ()
        {
          ...
          if (jQuery(".wdwt_image_info_container1").css("display") == 'none') {
            jQuery(".wdwt_image_info_container1").css("display", "table-cell");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Hide info', "news-magazine"); ?>");
          }
          else {
            jQuery(".wdwt_image_info_container1").css("display", "none");
            jQuery(".wdwt_info").attr("title", "<?php echo __('Show info', "news-magazine"); ?>");
          }
        ...
        jQuery(".wdwt_toggle_container").on(wdwt_click, function ()
        {
          ...
          if (jQuery(".wdwt_toggle_container i").hasClass(wdwt_open_toggle_btn_class)) {
            ...
            jQuery(".wdwt_ctrl_btn_container").animate({<?php echo $theme_row['lightbox_ctrl_btn_pos']; ?> :
            '-' + jQuery(".wdwt_ctrl_btn_container").height()
          },
            500
          )
            ;
            ...
            <?php echo $theme_row['lightbox_ctrl_btn_pos']; ?>:
            0
          },
            {
              duration: 500,
            ...
            :
              function ()
              {
                jQuery(".wdwt_toggle_container i").attr("class", "wdwt_toggle_btn fa " + wdwt_close_toggle_btn_class)
              }
            }
          )
            ;
            ...
            :
              function ()
              {
                jQuery(".wdwt_toggle_container i").attr("class", "wdwt_toggle_btn fa " + wdwt_open_toggle_btn_class)
              }
            }
          )
            ;
        ...
        jQuery(".wdwt_resize-full").on(wdwt_click, function ()
        {
          ...
          if (jQuery(".wdwt_resize-full").hasClass("fa-resize-small")) {
            ...
            jQuery(".wdwt_image_container").animate({
              height: wdwt_popup_current_height,
              width: wdwt_popup_current_width
            }, 500);
            ...
            jQuery(".wdwt_resize-full").attr("class", "wdwt_ctrl_btn wdwt_resize-full fa fa-resize-full");
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "news-magazine"); ?>");
          }
          else {
            wdwt_popup_current_width = jQuery(window).width();
            wdwt_popup_current_height = jQuery(window).height();
            ...
            jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Restore', "news-magazine"); ?>");
            jQuery(".wdwt_spider_popup_close").attr("class", "wdwt_ctrl_btn wdwt_spider_popup_close_fullscreen");
          }
        ...
        jQuery(".wdwt_fullscreen").on(wdwt_click, function ()
        {
          ...
          function wdwt_exit_fullscreen()
          {
            ...
            jQuery("#wdwt_spider_popup_wrap").on("fscreenclose", function ()
            {
              ...
              jQuery(".wdwt_resize-full").attr("title", "<?php echo __('Maximize', "news-magazine"); ?>");
              jQuery(".wdwt_fullscreen").attr("class", "wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen");
              jQuery(".wdwt_fullscreen").attr("title", "<?php echo __('Fullscreen', "news-magazine"); ?>");
              if ((jQuery("#wdwt_spider_popup_wrap").width() < jQuery(window).width()) && (jQuery("#wdwt_spider_popup_wrap").height() < jQuery(window).height())) {
                jQuery(".wdwt_spider_popup_close_fullscreen").attr("class", "wdwt_spider_popup_close");
              }
            });
          ...
          if (typeof jQuery().fullscreen !== 'undefined' && jQuery.isFunction(jQuery().fullscreen)) {
            if (jQuery.fullscreen.isFullScreen()) {
              ...
              jQuery(".wdwt_fullscreen").attr("title", "<?php esc_attr_e('Exit Fullscreen', "news-magazine"); ?>");
              jQuery(".wdwt_spider_popup_close").attr("class", "wdwt_ctrl_btn wdwt_spider_popup_close_fullscreen");
        ...
        jQuery(".wdwt_play_pause, .wdwt_popup_image").on(wdwt_click, function ()
        {
          if (jQuery(".wdwt_ctrl_btn").hasClass("fa-play")) {
            /* PLay.*/
            wdwt_play();
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Pause', "news-magazine"); ?>");
            ...
            window.clearInterval(wdwt_playInterval);
            jQuery(".wdwt_play_pause").attr("title", "<?php echo __('Play', "news-magazine"); ?>");
