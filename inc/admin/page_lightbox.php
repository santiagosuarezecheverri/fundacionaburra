  ...
  function __construct(){
    ...
    $this->options = array( 
      ...
      'lbox_slideshow_interval' => array( 
        ...
        "title" => __("Slideshow interval.", "news-magazine"), 
        'type' => 'text',
        'input_size' => '3',
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Interval of slideshow in seconds.", "news-magazine"), 
        'section' => 'lightbox', 
        'tab' => 'lightbox',
        'default' => 5 ,
        'customizer' => array()     
      ...
      'lbox_image_width' => array( 
        ...
        "title" => __("Lightbox width.", "news-magazine"), 
        'type' => 'text',
        'input_size' => '4', 
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Lightbox width.", "news-magazine"), 
        'section' => 'lightbox', 
        'tab' => 'lightbox',
        'default' => 600 ,
        'customizer' => array()     
      ...
      'lbox_image_height' => array( 
        ...
        "title" => __("Lightbox height.", "news-magazine"), 
        'type' => 'text',
        'input_size' => '4',
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Lightbox height.", "news-magazine"), 
        'section' => 'lightbox', 
        'tab' => 'lightbox',
        'default' => 400 ,
        'customizer' => array()
      ...
      $this->options["lbox_image_effect"] = array(
        ...
        "title" => __("Lightbox transition effect", "news-magazine"), 
        'type' => 'select',
        "valid_options" => array(
                            'none'=>'None',
        ...
        "sanitize_type" => "sanitize_text_field",
        "description" => __("Lightbox transition effect", "news-magazine" ),
        'section' => 'lightbox', 
        'tab' => 'lightbox', 
        'default' => array('fade'),
        'customizer' => array()
      ...
      $this->options['lbox_enable_image_fullscreen'] = array(
        ...
        'title' =>  __( 'Enable fullscreen buttons', "news-magazine" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_open_with_fullscreen'] = array(
        ...
        'title' =>  __( 'Open lightbox with fullscreen.', "news-magazine" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_enable_image_ctrl_btn'] = array(
        ...
        'title' =>  __( 'Enable play and pause buttons.', "news-magazine" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_open_with_autoplay'] = array(
        ...
        'title' =>  __( 'Open with autoplay.', "news-magazine" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options['lbox_popup_enable_info'] = array(
        ...
        'title' =>  __( 'Enable info in lightbox.', "news-magazine" ), 
        'type' => 'checkbox_open', 
        'description' => __( 'Add post title and excerpt as image info in lightbox.', "news-magazine" ), 
        'section' => 'lightbox',
    ...
    $this->options['lbox_popup_info_always_show'] = array(
        ...
        'title' =>  __( 'Always show info in lightbox.', "news-magazine" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
    ...
    $this->options['lbox_popup_info_full_width'] = array(
        ...
        'title' =>  __( 'Full-width info in lightbox.', "news-magazine" ), 
        'type' => 'checkbox', 
        'description' => '', 
        'section' => 'lightbox',  
        'tab' => 'lightbox', 
      ...
      $this->options["lbox_info_position"] = array(
        ...
        "title" => __("Image info position", "news-magazine" ),
        'type' => 'select',
        "description" => "",
        "valid_options" => array(
          "left-top" => "left-top",
