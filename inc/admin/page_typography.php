  ...
  function __construct()
  {
    $this->options = array(
      ...
      'text_headers_font' => array(
        ...
        'title' => __('Select Font', "news-magazine"),
        'description' => __('Fonts with * are not loaded from Google, they will be displayed only if visitor\'s device has them installed.', "news-magazine"),
        'type' => 'select_style',
      ...
      'text_headers' => array(
        'name' => 'text_headers',
        'title' => __('Preview', "news-magazine"),
        'type' => 'text_preview',
        'section' => 'text_headers',
        'tab' => 'typography',
        'default' => ''
      ...
      'text_headers_button' => array(
        ...
        'title' => __('Edit font styling', "news-magazine"),
        'type' => 'button',
        'show' => array(
          'text_headers_kern',
      ...
      'text_headers_kern' => array(
        ...
        'title' => __('Letter Spacing', "news-magazine"),
        'type' => 'select_style',
      ...
      'text_headers_transform' => array(
        ...
        'title' => __('Text Transform', "news-magazine"),
        'type' => 'select_style',
      ...
      'text_headers_variant' => array(
        ...
        'title' => __('Variant', "news-magazine"),
        'type' => 'select_style',
